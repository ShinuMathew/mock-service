...
class CourseDBAccessor {
    ...
    async publishCourse(params) {
        try {
            ...
            logger.error(`Error occurred in publishCourse DBAccessor :\n ${err}`)
            throw err;
        }
    }
    ...
    async updateCourse(params) {
        try {
            ...
            logger.error(`Error occurred in updateCourse DBAccessor :\n ${err}`)
            throw err;
        }
    }
    ...
    async getAllCourses() {
        try {
            ...
            logger.error(`Error occurred in getAllCourses DBAccessor :\n ${err}`)
            throw err;
        }
    }
    ...
    async getSpecificCourse(id) {
        try {
            ...
            logger.error(`Error occurred in getSpecificCourses DBAccessor :\n ${err}`)
            throw err;
        }
    }
    ...
    async deleteSpecificCourse(id) {
        try {
            ...
            logger.error(`Error occurred in deleteSpecificCourse DBAccessor :\n ${err}`)
            throw err;
        }
    }
}
